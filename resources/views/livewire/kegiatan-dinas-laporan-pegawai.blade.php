<div class="py-12 px-4 sm:px-6 lg:px-8 bg-slate-50 min-h-screen" x-data="{ printing: false }">
    <div class="max-w-7xl mx-auto space-y-8">
        ...
        <div class="flex flex-col lg:flex-row lg:items-center justify-between gap-8 bg-white/70 backdrop-blur-xl p-8 rounded-[3rem] shadow-2xl shadow-slate-200/50 border border-white/80 ring-1 ring-slate-100 animate-fade-in-up">
            <div class="space-y-2">
                <div class="inline-flex items-center gap-2 bg-emerald-50 text-emerald-600 px-4 py-1.5 rounded-full text-[10px] font-black uppercase tracking-[0.2em] mb-2">
                    <span class="relative flex h-2 w-2">
                        <span class="animate-ping absolute inline-flex h-full w-full rounded-full bg-emerald-400 opacity-75"></span>
                        <span class="relative inline-flex rounded-full h-2 w-2 bg-emerald-600"></span>
                    </span>
                    Pegawai & Pendamping Setwan
                </div>
                <h1 class="text-4xl lg:text-5xl font-black text-slate-900 tracking-tight">Laporan Staf</h1>
                <p class="text-slate-500 font-medium text-lg lg:text-xl max-w-xl leading-relaxed">Pantau keterlibatan staf dan pendamping dalam perjalanan dinas.</p>
            </div>
            
            <div class="flex flex-wrap items-center gap-5">
                <div class="flex bg-slate-100/80 backdrop-blur-md p-1.5 rounded-[1.5rem] border border-slate-200/50 shadow-inner">
                    <button wire:click="setRange('week')" class="px-6 py-3 rounded-2xl text-[10px] font-black uppercase tracking-widest transition-all duration-300 {{ $rangeType == 'week' ? 'bg-white text-emerald-600 shadow-xl shadow-emerald-500/10' : 'text-slate-500 hover:text-slate-900 hover:bg-white/50' }}">Minggu</button>
                    <button wire:click="setRange('month')" class="px-6 py-3 rounded-2xl text-[10px] font-black uppercase tracking-widest transition-all duration-300 {{ $rangeType == 'month' ? 'bg-white text-emerald-600 shadow-xl shadow-emerald-500/10' : 'text-slate-500 hover:text-slate-900 hover:bg-white/50' }}">Bulan</button>
                    <button wire:click="setRange('year')" class="px-6 py-3 rounded-2xl text-[10px] font-black uppercase tracking-widest transition-all duration-300 {{ $rangeType == 'year' ? 'bg-white text-emerald-600 shadow-xl shadow-emerald-500/10' : 'text-slate-500 hover:text-slate-900 hover:bg-white/50' }}">Tahun</button>
                    <button wire:click="setRange('custom')" class="px-6 py-3 rounded-2xl text-[10px] font-black uppercase tracking-widest transition-all duration-300 {{ $rangeType == 'custom' ? 'bg-white text-emerald-600 shadow-xl shadow-emerald-500/10' : 'text-slate-500 hover:text-slate-900 hover:bg-white/50' }}">Kustom</button>
                </div>

                @if($rangeType == 'custom')
                <div class="flex items-center gap-3 bg-white border border-slate-200/60 p-2 rounded-[1.5rem] shadow-sm hover:border-emerald-400 transition-all duration-300 animate-fade-in-up">
                ...
                <button @click="window.print()" class="group relative bg-slate-900 hover:bg-black text-white px-8 py-4 rounded-[1.5rem] text-[10px] font-black uppercase tracking-[0.2em] shadow-2xl shadow-slate-900/30 transition-all duration-500 overflow-hidden">
                    <div class="absolute inset-0 w-full h-full bg-gradient-to-r from-emerald-600 to-teal-600 opacity-0 group-hover:opacity-100 transition-opacity duration-500"></div>
                    <div class="relative flex items-center gap-3">
                        <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" d="M17 17h2a2 2 0 002-2v-4a2 2 0 00-2-2H5a2 2 0 00-2 2v4a2 2 0 002 2h2m2 4h6a2 2 0 002-2v-4a2 2 0 00-2-2H9a2 2 0 00-2 2v4a2 2 0 002 2zm8-12V5a2 2 0 00-2-2H9a2 2 0 00-2-2v4h10z"></path></svg>
        ...
        <!-- SUMMARY CARDS -->
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 animate-fade-in-up delay-100">
            <div class="bg-gradient-to-br from-emerald-600 via-emerald-700 to-teal-800 p-8 rounded-[3.5rem] shadow-2xl shadow-emerald-500/30 text-white relative overflow-hidden group transition-all duration-500 hover:-translate-y-2 hover:scale-[1.02]">
                ...
                <div class="relative z-10 space-y-6">
                    ...
                    <div>
                        <p class="text-emerald-100/80 text-[10px] font-black uppercase tracking-[0.3em]">Total Kegiatan Staf</p>
            ...
            <div class="bg-white/70 backdrop-blur-xl p-8 rounded-[3.5rem] shadow-xl shadow-slate-200/50 border border-white/80 relative overflow-hidden group transition-all duration-500 hover:-translate-y-2 hover:scale-[1.02] ring-1 ring-slate-100">
                ...
                <div class="relative z-10 space-y-6">
                    ...
                    <div>
                        <p class="text-slate-400 text-[10px] font-black uppercase tracking-[0.3em]">Total Hari Dinas</p>
            ...
            <div class="bg-white/70 backdrop-blur-xl p-8 rounded-[3.5rem] shadow-xl shadow-slate-200/50 border border-white/80 relative overflow-hidden group transition-all duration-500 hover:-translate-y-2 hover:scale-[1.02] ring-1 ring-slate-100">
                ...
                <div class="relative z-10 space-y-6">
                    ...
                    <div>
                        <p class="text-slate-400 text-[10px] font-black uppercase tracking-[0.3em]">Staf Terlibat</p>
                        <h3 class="text-5xl font-black text-slate-900 mt-2 tracking-tighter">{{ $stats['pegawai_stats']->count() }} <span class="text-xl font-medium text-slate-400">Orang</span></h3>
                    </div>
                </div>
            </div>
            ...
            <div class="bg-white/70 backdrop-blur-xl p-8 rounded-[3.5rem] shadow-xl shadow-slate-200/50 border border-white/80 relative overflow-hidden group transition-all duration-500 hover:-translate-y-2 hover:scale-[1.02] ring-1 ring-slate-100">
                ...
                <div class="relative z-10 space-y-6">
                    ...
                    <div>
                        <p class="text-slate-400 text-[10px] font-black uppercase tracking-[0.3em]">Total Insentif Staf</p>
        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-8 animate-fade-in-up delay-200">
            ...
            <div class="bg-white/70 backdrop-blur-xl p-10 rounded-[3.5rem] shadow-xl shadow-slate-200/50 border border-white/80 min-h-[500px] flex flex-col relative overflow-hidden group ring-1 ring-slate-100">
                <div class="relative z-10 flex items-center justify-between mb-10">
                    <div>
                        <h3 class="text-2xl font-black text-slate-900 tracking-tight">Staf Paling Aktif</h3>
            ...
            <div class="bg-white/70 backdrop-blur-xl p-10 rounded-[3.5rem] shadow-xl shadow-slate-200/50 border border-white/80 min-h-[500px] flex flex-col relative overflow-hidden group ring-1 ring-slate-100">
                <div class="relative z-10 flex items-center justify-between mb-10">
                    <div>
                        <h3 class="text-2xl font-black text-slate-900 tracking-tight">Penggunaan Anggaran Staf</h3>
        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-8 animate-fade-in-up delay-300">
            ...
            <div class="bg-white/70 backdrop-blur-xl p-10 rounded-[3.5rem] shadow-xl shadow-slate-200/50 border border-white/80 min-h-[500px] flex flex-col relative overflow-hidden group ring-1 ring-slate-100">
                 <div class="relative z-10 flex items-center justify-between mb-10">
                    <div>
                        <h3 class="text-2xl font-black text-slate-900 tracking-tight">Tren Insentif</h3>
            ...
            <div class="bg-white/70 backdrop-blur-xl p-10 rounded-[3.5rem] shadow-xl shadow-slate-200/50 border border-white/80 min-h-[500px] flex flex-col relative overflow-hidden group ring-1 ring-slate-100">
                <div class="relative z-10 flex items-center justify-between mb-10">
                    <div>
                        ...
                        <p class="text-[10px] text-slate-400 font-black uppercase tracking-[0.2em] mt-1">Duration by Staff</p>
                    </div>
        ...
        <div class="grid grid-cols-1 xl:grid-cols-12 gap-10 animate-fade-in-up delay-300">
            <div class="xl:col-span-12 bg-white/70 backdrop-blur-xl rounded-[3.5rem] shadow-xl shadow-slate-200/50 border border-white/80 overflow-hidden ring-1 ring-slate-100">
                <div class="p-10 border-b border-slate-50 flex items-center justify-between bg-slate-50/30">
                    <div>
                        <h3 class="text-2xl font-black text-slate-900 tracking-tight">Ranking Partisipasi Staf & Pendamping</h3>
                    ...
                    <div class="bg-emerald-600 text-white px-5 py-2.5 rounded-2xl text-[10px] font-black uppercase tracking-widest shadow-lg shadow-emerald-500/30">
                        {{ $stats['pegawai_stats']->count() }} Staf
                    </div>
                </div>
                    ...
                    <table class="w-full text-left">
                        <thead>
                            <tr class="bg-slate-50/50">
                                <th class="px-10 py-6 text-[10px] font-black uppercase tracking-[0.2em] text-slate-400">Nama Staf</th>
                        ...
                        <tbody class="divide-y divide-slate-100 text-sm">
                            @foreach($stats['pegawai_stats'] as $p)
                            <tr wire:click="openTrips({{ $p->v_id }}, '{{ $p->v_nama }}')" class="hover:bg-emerald-50/30 transition-all duration-300 group cursor-pointer">
                                <td class="px-10 py-8">
                                    <div class="flex items-center gap-6">
                                        <div class="w-14 h-14 rounded-full bg-gradient-to-tr from-slate-100 to-slate-200 border-4 border-white flex items-center justify-center text-slate-500 font-black text-lg group-hover:from-emerald-600 group-hover:to-teal-600 group-hover:text-white transition-all duration-500 shadow-md">
                                            {{ substr($p->v_nama, 0, 1) }}
                                        </div>
                                        <div>
                                            <span class="font-black text-slate-800 text-xl tracking-tight block">{{ $p->v_nama }}</span>
                                            <span class="text-[10px] text-slate-400 font-bold uppercase tracking-widest">{{ $p->v_jabatan }}</span>
                                        </div>
                                    </div>
                                </td>
                                ...
                                <td class="px-10 py-8 text-center group-hover:scale-110 transition-transform duration-500">
                                    <div class="inline-flex flex-col items-center">
                                        <span class="text-xl font-black text-rose-600">Rp {{ number_format($p->total_nominal, 0, ',', '.') }}</span>
                                        <span class="text-[10px] text-slate-400 font-bold uppercase tracking-widest mt-1">Rp {{ number_format($p->avg_uang_harian, 0, ',', '.') }}/Hari</span>
                                    </div>
                                </td>
                        ...
                        <div class="space-y-4">
                            @forelse($modalTrips as $trip)
                                <div class="relative group">
                                    <div class="absolute -inset-1 bg-gradient-to-r from-emerald-500 to-teal-600 rounded-[3rem] blur opacity-0 group-hover:opacity-10 transition duration-500"></div>
                                    <div class="relative bg-white p-8 rounded-[3rem] border border-slate-100 shadow-xl shadow-slate-200/50 hover:shadow-2xl hover:shadow-emerald-500/10 transition-all duration-500 overflow-hidden">
                                        ...
                                        <div class="flex flex-col lg:flex-row lg:items-center justify-between gap-6 mb-8">
                                            <div class="space-y-3 flex-1">
                                                ...
                                                <h4 class="text-2xl font-black text-slate-900 leading-tight group-hover:text-emerald-600 transition-colors">{{ $trip->nama_kegiatan }}</h4>
                                            ...
                                            <div class="flex flex-col items-end gap-1 shrink-0 p-6 bg-slate-50 rounded-[2rem] border border-slate-100 group-hover:bg-emerald-600 group-hover:text-white transition-all duration-500 shadow-inner">
                                                @if(isset($trip->nominal_personal))
                                                    ...
                                                    <div class="mt-2 flex items-center gap-3">
                                                        <div class="flex items-center gap-1.5 p-1 px-3 bg-white/20 backdrop-blur-md rounded-lg group-hover:bg-white/10 outline outline-1 outline-emerald-500/20">
                                                            <span class="text-[9px] font-black group-hover:text-white/80 uppercase tracking-widest text-emerald-600">Total Akumulasi: Rp {{ number_format($trip->total_nominal, 0, ',', '.') }}</span>
                                                        </div>
                                                @else
        ...
        document.addEventListener('livewire:initialized', () => {
            ...
            function initCharts(updatedStats = null) {
                ...
                const top5ActivityOptions = {
                    ...
                    xaxis: { categories: stats.top5_activity.map(a => a.v_nama) },
                    legend: { show: false },
                ...
                const top5BudgetOptions = {
                    ...
                    xaxis: { 
                        categories: stats.top5_budget.map(a => a.v_nama),
                        labels: {
                ...
                // 4. Hari Chart (Donut) - Top 5 Staff Duration Distribution or All? 
                // Using top 5 activity staff for this to keep it clean, or we can use the main stats if not too large.
                // Let's use top 5 activity list for distribution to match context.
                const hariOptions = {
                    series: stats.top5_activity.map(a => parseInt(a.total_hari)),
                    chart: { type: 'donut', height: 350, fontFamily: 'Outfit, sans-serif' },
                    labels: stats.top5_activity.map(a => a.v_nama),
                        ...
                        pie: { 
                            donut: { 
                                ...
                                labels: { 
                                    ...
                                    value: { show: true, fontWeight: 900 } 
                                } 
                            } 
                        } 
                    },
