<x-app-layout>
    <x-slot name="header">
        <div class="flex justify-between items-center">
            ...
            <a href="{{ route('anggota.create') }}" style="background-color: #1e293b; color: white;" class="flex items-center gap-2 bg-slate-800 hover:bg-slate-900 active:bg-slate-950 text-white px-5 py-2.5 rounded-xl font-bold shadow-md hover:shadow-lg transition-all duration-200 border border-slate-700">
                        ...
                        <tbody class="bg-white divide-y divide-gray-200">
                            ...
                            <tr>
                                <td class="px-6 py-4 whitespace-nowrap">
                                    ...
                                    <div class="text-sm text-gray-500">{{ $anggota->nip }}</div>
                                </td>
                                ...
                                <!-- Edit -->
                                    <a href="{{ route('anggota.edit', $anggota) }}" class="text-blue-600 hover:text-blue-900 border border-blue-200 rounded-lg p-1 hover:bg-blue-50 transition inline-block">
                                        <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M11 5H6a2 2 0 00-2 2v11a2 2 0 002 2h11a2 2 0 002-2v-5m-1.414-9.414a2 2 0 112.828 2.828L11.828 15H9v-2.828l8.586-8.586z"></path></svg>
                                    </a>
                                    <!-- Delete -->
                                    <button @click="confirmingDeletion = true; deletingUrl = '{{ route('anggota.destroy', $anggota) }}'" class="text-red-600 hover:text-red-900 border border-red-200 rounded-lg p-1 hover:bg-red-50 transition inline-block">
